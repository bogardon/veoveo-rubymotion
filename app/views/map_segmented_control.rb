class MapSegmentedControl < UISegmentedControl
  ...
  def initWithItems(items)
    ...
    self.setDividerImage(UIImage.alloc.init, forLeftSegmentState:UIControlStateNormal, rightSegmentState:UIControlStateSelected, barMetrics:UIBarMetricsDefault)
